...
const calculatorOptions = [
  {
    ...
    name: "SIP Calculator",
    title: "SIP",
    info: "A Systematic Investment Plan (SIP) lets you invest a fixed amount every month in mutual funds. See how your monthly investments can grow over time with compounding.",
    component: HomeSIPCalculator,
  },
  {
    id: "lumpsum",
    name: "Lumpsum Calculator",
    title: "Lumpsum",
    info: "Invest a one-time amount and see its estimated value at the end of your chosen period, based on the expected annual return.",
  ...
  },
  {
    ...
    name: "SWP Calculator",
    title: "SWP",
    info: "A Systematic Withdrawal Plan (SWP) lets you withdraw a fixed amount every month from your investment. See how much you withdraw in total and what remains at the end.",
  ...
  },
  {
    ...
    title: "Retirement",
    info: "Estimate the corpus you need for retirement after inflation, and the monthly SIP required to build it before you retire.",
  ...
  },
  {
    ...
    title: "Goal Planning",
    info: "Planning for a house, education or a car? Enter your goal amount and timeline to find the monthly SIP you need to reach it.",
  ...
  },
  {
    ...
    name: "EMI Calculator",
    title: "EMI",
    info: "Calculate the monthly EMI for a home, personal, vehicle or education loan, along with the total interest and total amount payable.",
...
export function Calculators() {
  ...
  const selected = calculatorOptions.find((calc) => calc.id === activeCalculator) ?? calculatorOptions[0]
  ...
  return (
    ...
    >
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 sm:mb-12 md:mb-16 text-center">
        <span className="text-gray-800">{selected.title}</span> <span className="text-red-600">Calculator</span>
      </h2>
      ...
      <div className="flex flex-col lg:flex-row items-start justify-center gap-6 sm:gap-8 lg:gap-12 max-w-7xl w-full">
        ...
        >
          ...
          <div className="flex flex-col gap-1 sm:gap-2">
            {calculatorOptions.map((calc) => (
              <button
                ...
                className={`text-left border-l-4 pl-3 hover:text-red-600 hover:translate-x-2 transition-all duration-300 py-2 text-base sm:text-lg font-medium ${
                  activeCalculator === calc.id ? "text-red-600 border-red-600" : "text-gray-700 border-transparent"
                }`}
              >
                {calc.name}
              </button>
          ...
          <a href={`/calculators?tab=${activeCalculator}`} className="block mt-6 sm:mt-8">
        ...
        >
          <div className="mb-4 sm:mb-6 rounded-xl bg-red-50 border border-red-100 p-3 sm:p-4">
            <h3 className="text-base sm:text-lg font-bold text-gray-800">{selected.name}</h3>
            <p className="text-xs sm:text-sm text-gray-600 mt-1 leading-relaxed">{selected.info}</p>
          </div>
          <motion.div
            key={selected.id}
